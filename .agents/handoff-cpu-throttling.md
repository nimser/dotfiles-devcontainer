...
- `private_dot_config/brave-flags.conf` (new) — GPU acceleration flags
- `private_dot_config/chromium-flags.conf` (updated) — same flags
- `private_dot_local/bin/executable_brave-browser` (new) — wrapper script
- `private_dot_local/bin/executable_brave-browser0` (updated) — whitelist wrapper+flags
