...
return {
  ...
  keys = {
    ...
    --- Zettelkasten
    { "<localleader>fj",   function() Snacks.picker.files({ cwd = "~/Sync/00 Zettelkasten/Journal/" }) end,                desc = "Find journal note" },
    { "<localleader>fn",   function() Snacks.picker.files({ cwd = "~/Sync/00 Zettelkasten/" }) end,                        desc = "Find zettlekasten note" },
    { "<localleader>ft",   function() Snacks.picker.files({ cwd = "~/Sync/00 Zettelkasten/ZZ_Resources/Templates/" }) end, desc = "Find zettlekasten Template" },
    { "<localleader>gn",   function() Snacks.picker.grep({ cwd = "~/Sync/00 Zettelkasten/" }) end,                         desc = "Grep zettelkasten note" },
    --- ~/code
